...
<div class="container2">
    ...
    <button class="button" onclick="scrollToForm2()" onmouseover="showText('Если у Вас есть прайс-лист Вы можете загрузить все ваши товары используя функцию импорта')" onmouseout="hideText()">Загрузить товары из прайс-листа</button>
...
<div class="container" id="import-product-form">
    ...
    <form action="{{ route('cars.import') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="import">
            <a href="{{ asset('import.xlsx') }}" class="btn btn-secondary" download>Скачать пример файла</a>
        </div>
    </form>
